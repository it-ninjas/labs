---
title: "TITEL DER GESAMTAUFGABE"
linkTitle: "Kurzversion"
weight: 1
description: >
  Kurze Zusammenfassung der gesamten Aufgabe (1–2 Sätze).
---

Diese Aufgabe besteht aus mehreren Teilen.

> Falls nicht anders angegeben, müssen die Teilaufgaben in der Reihenfolge gelöst werden, in der sie
> aufgelistet sind.

> Optionale Aufgaben können weggelassen werden.
...
## Voraussetzungen _(optional)_

Bevor du mit der Aufgabe beginnst, sollten folgende Voraussetzungen erfüllt sein:

- Ich habe die Java-Grundlagen verstanden.
- Ich kann IntelliJ bedienen und neue Java-Projekte erstellen.
- Ich weiss, wie ich ein Git-Repository erstelle (Bitbucket oder GitHub) und es lokal klone.
- …
