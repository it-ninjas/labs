...
description: >
  ...
  - Ich kann typische Eingaben (E-Mail, IBAN, Telefonnummern, URLs, Passwörter, PLZ) validieren.
  - Ich verstehe, wie man Regex schrittweise und sicher testet.
---

---

title: "Regex – Extrahieren und Validieren"
linkTitle: "Regex"
weight: 30
description: >
Lerne, wie du mit regulären Ausdrücken E-Mails, IBANs, Telefonnummern, URLs, Passwörter und PLZ erkennst.
...
### 1) E-Mail-Adressen aus einem Text extrahieren
...
### 6) Schweizer Postleitzahlen (CH-PLZ)
