...
weight: 3
description: >
  Aufgaben zu [Java Collections - Map](../../../docs/02_java/08_java-collections/04_map)
---
...
4. Ein eigenes Testing (wie in [J4 Testing](../../../../docs/02_java/10_java-testing) gelernt) soll umgesetzt werden.
...
5. Ein eigenes Testing (wie in [J4 Testing](../../../../docs/02_java/10_java-testing) gelernt) soll umgesetzt werden.
...
3. Ein eigenes Testing (wie in [J4 Testing](../../../../docs/02_java/10_java-testing) gelernt) soll umgesetzt werden.
